...
interface ScheduleDao: JpaRepository<ScheduleEntity, Int> {


        @Query(name = "getScheduleById")
        fun getScheduleById(@Param("id") id: Int): ScheduleEntity?

        fun getScheduleByCompany_Id(@Param("id") id: Int): ScheduleEntity?
